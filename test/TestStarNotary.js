...
it('lets a user transfer a star', async () => {
    ...
    let starid1 = 8;
    let user2=accounts[2];
    await instance.createStar('awesome star8', starid1, { from: user1 });
    assert(await instance.ownerOf.call(starid1), user1);
...
it('lookUptokenIdToStarInfo test', async () => {
    ...
    let user1 = accounts[1];
    let starid1 = 10;
    let name='awesome star8'
    await instance.createStar(name, starid1, { from: user1 });
    let star_name=await instance.lookUptokenIdToStarInfo(starid1);
    assert(star_name,name);
    // 1. create a Star with different tokenId
